...
<div class="vhalign" style="font-size:18px;height:10%;background:rgb(60,60,60);color:white;text-align:center;">
    <?php
    ...
    echo '<b>' . $time . '</b> at <b>' . $date . '</b> to <b>' . $timeE . '</b> at <b>' . $dateE . '</b>'; ?>
</div>
<div style="height:20%;">
...
<div style="text-shadow:0 1px 0 rgba(0,0,0,0.5);width:100%;margin:0;height:10%;background:rgb(50,50,50);font-size:20px;" class="second row">
    ...
    <a id="more" href="index.php" style="height:100%;color:white;padding:0;border:1px solid rgb(30,30,30)" class="col-xs-6 vhalign">
        BACK TO MENU
    </a>
</div>
